  ...
  return (
    <>
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <Card className="w-[400px] bg-white pb-5 shadow-lg">
          <CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Button
                className="w-full py-5 mt-5 bg-buttonBgColor hover:bg-buttonHover text-white"
                type="submit"
        ...
        {showModal && (
          <PasswordSuccessModal
            onRedirect={() => signOut({ callbackUrl: "/auth/signin" })}
          />
        )}
      </div>
    </>
